...
class top (val IN_WIDTH: Int, val C_WIDTH: Int, val SA_ROWS: Int, val SA_COLS: Int) extends Module {
  ...
  inBuffer_h.io.ctrl_ib_data_in := controller.io.ctrl_ib_data_in
  ...
  inBuffer_v.io.ctrl_ib_data_in := controller.io.ctrl_ib_data_in
  ...
  controller.io.ibh_empty := inBuffer_h.io.ib_empty
  controller.io.ibv_data_in_done := inBuffer_v.io.ib_data_in_done
  controller.io.ibv_empty := inBuffer_v.io.ib_empty
